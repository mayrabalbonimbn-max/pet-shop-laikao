...
export default function CartPage() {
  return (
    <div className="content-container py-10 sm:py-14">
      <section className="grid gap-8 rounded-[32px] border border-brand-100 bg-linear-to-br from-brand-200 via-white to-[var(--magenta-100)]/80 p-6 shadow-[var(--shadow-soft)] sm:p-8 xl:grid-cols-[1.08fr_0.92fr]">
        <div className="space-y-5">
          ...
          <p className="max-w-3xl text-base leading-7 text-stone-500">
            O carrinho continua conectado ao backend real da loja, mas agora conversa melhor com a nova identidade lilas e promocional do site.
          </p>
        ...
        <div className="grid gap-3 md:grid-cols-3 xl:grid-cols-1">
          ...
          <article className="rounded-[var(--radius-lg)] border border-[var(--sun-300)] bg-[var(--sun-100)]/82 p-5 shadow-[var(--shadow-soft)]">
            <AlertTriangle className="h-5 w-5 text-warning-500" />
            <p className="mt-3 text-sm font-semibold text-brand-950">Erros mais explicitos</p>
            <p className="mt-2 text-sm leading-6 text-brand-900/78">Estoque, cupom invalido e valor atualizado deixam de parecer falha escondida.</p>
          </article>
        </div>
      </section>
